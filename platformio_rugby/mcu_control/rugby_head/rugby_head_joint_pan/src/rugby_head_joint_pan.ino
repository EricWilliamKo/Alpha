...
#define LEFTLIMIT_STATE 102 //HOME_ZONE_STATE 2
#define RIGHTLIMIT_STATE 103
#define WORKING_RANGE_STATE 104
#define MINLIMITREACHED LEFTLIMIT_STATE
#define MAXLIMITREACHED RIGHTLIMIT_STATE
int STATE = HOME_STATE;
int INIT1stSeqFlag = false;
int INIT2ndSeqFlag = false;
double WORKING_RANGE = 0.0;
const double INIT_STATE_Volt =  3.0; // Unit : V
