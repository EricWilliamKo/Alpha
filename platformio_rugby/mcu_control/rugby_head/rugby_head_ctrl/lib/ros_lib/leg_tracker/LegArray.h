...
namespace leg_tracker
{
  ...
  class LegArray : public ros::Msg
  {
    public:
      ...
      leg_tracker::Leg st_legs;
      leg_tracker::Leg * legs;

    LegArray():
      header(),
      legs_length(0), legs(NULL)
    {
    }
    ...
    const char * getType(){ return "leg_tracker/LegArray"; };
    const char * getMD5(){ return "9e932f47090c69cbf30f535c2ab02e32"; };
