...
namespace joint_qualification_controllers
{
  ...
  class HysteresisData : public ros::Msg
  {
    ...
    HysteresisData():
      joint_name(""),
      time_up_length(0), time_up(NULL),
      effort_up_length(0), effort_up(NULL),
      position_up_length(0), position_up(NULL),
      velocity_up_length(0), velocity_up(NULL),
      time_down_length(0), time_down(NULL),
      effort_down_length(0), effort_down(NULL),
      position_down_length(0), position_down(NULL),
      velocity_down_length(0), velocity_down(NULL),
      arg_name_length(0), arg_name(NULL),
      arg_value_length(0), arg_value(NULL)
    {
    }
