...
namespace joint_qualification_controllers
{
  ...
  class WristRollTurn : public ros::Msg
  {
    ...
    WristRollTurn():
      ...
      flex_position_length(0), flex_position(NULL),
      flex_effort_length(0), flex_effort(NULL),
      flex_cmd_length(0), flex_cmd(NULL),
      roll_position_length(0), roll_position(NULL),
      roll_effort_length(0), roll_effort(NULL),
      roll_cmd_length(0), roll_cmd(NULL),
      roll_velocity_length(0), roll_velocity(NULL)
    {
    }
